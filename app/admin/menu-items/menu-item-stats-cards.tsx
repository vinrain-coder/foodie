...
interface MenuItemStatsCardsProps {
  stats: {
    ...
    outOfStockMenuItems: number;
    lowStockMenuItems: number;
  };
  currentStatus?: string;
}

export default function MenuItemStatsCards({
  stats,
  currentStatus = "all",
}: MenuItemStatsCardsProps) {
  ...
  const statConfig = [
    ...
    },
    {
      id: "true",
      label: "Published",
      value: stats.publishedMenuItems,
      icon: Eye,
      color:
    ...
    },
    {
      id: "out_of_stock",
      label: "Out of Stock",
      value: stats.outOfStockMenuItems,
      icon: Archive,
