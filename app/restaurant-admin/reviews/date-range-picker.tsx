...
export function ReviewsDateRangePicker({ className }: { className?: string }) {
  ...
  const [draftCalendarDate, setDraftCalendarDate] = React.useState<
    DateRange | undefined
  >(appliedDateRange);
        ...
        <PopoverContent className="w-auto p-0" align="end">
          ...
          <div className="flex gap-4 p-4 pt-0">
            <PopoverClose asChild>
              <Button onClick={() => applyRange(draftCalendarDate)}>
                Apply
              </Button>
            </PopoverClose>
            <PopoverClose asChild>
              <Button
                variant={"outline"}
                onClick={() => setDraftCalendarDate(appliedDateRange)}
              >
                Cancel
              </Button>
            </PopoverClose>
