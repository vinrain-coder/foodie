    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="relative overflow-hidden border-l-4 border-l-emerald-500 shadow-sm transition-all hover:shadow-md">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              <Price price={data.totalSales} plain />
            </div>
        ...
        <Card className="relative overflow-hidden border-l-4 border-l-indigo-500 shadow-sm transition-all hover:shadow-md">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              <Price price={data.avgOrderValue} plain />
            </div>
            <p className="text-xs text-muted-foreground mt-1">
        ...
        <Card className="relative overflow-hidden border-l-4 border-l-amber-500 shadow-sm transition-all hover:shadow-md">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatNumber(data.reviewsCount)}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
        ...
        <Card className="relative overflow-hidden border-l-4 border-l-blue-500 shadow-sm transition-all hover:shadow-md">
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Menu Item</CardTitle>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatNumber(data.menuItemsCount)}
            </div>
            <p className="text-xs text-muted-foreground mt-1">
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Card className="lg:col-span-2 shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Daily revenue trends in selected period
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Sales distribution by menuItem category
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Latest customer feedback across store
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Revenue trajectory over last 6 months
            </CardDescription>
          </CardHeader>
          <CardContent>
        ...
        <Card className="shadow-sm">
          <CardHeader>
            ...
            <CardDescription>
              Highest performing menuItems by sales
            </CardDescription>
          </CardHeader>
          <CardContent>
            <TableChart data={data.topSalesMenuItems} labelType="menuItem" />
          </CardContent>
        </Card>
      </div>
                ...
                {data.latestOrders.map((order: IOrderList) => (
                  <TableRow key={order._id} className="hover:bg-muted/30">
                    ...
                    <TableCell className="text-right">
                      <Link
                        href={`/restaurant-admin/orders/${order._id}`}
