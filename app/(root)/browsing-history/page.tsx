...
import MenuItemCard from "@/components/shared/menuItem/menu-item-card";
...
export default function BrowsingHistoryPage() {
  const { menuItems: historyItems, removeItem, clear } = useBrowsingHistory();
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Review and manage the menuItems you&apos;ve viewed.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-muted-foreground max-w-xs mx-auto mt-2">
            You haven&apos;t viewed any menuItems yet. Start browsing to see
            your history here.
          </p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-2">
          {data.map((menuItem) => (
            <div key={menuItem._id} className="group relative flex flex-col">
              <MenuItemCard menuItem={menuItem} hideDetails />
              <Button
                variant="ghost"
                size="sm"
                ...
                onClick={() => {
                  ...
                  setData((prev) => prev.filter((p) => p._id !== menuItem._id));
                }}
              >
