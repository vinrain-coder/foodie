          ...
          <CardHeader className="flex-row items-start justify-between space-y-0 gap-4 pb-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-1">
                {review.menuItem ? (
                  <Link href={`/menu-item/${review.menuItem.slug}`} className="hover:underline">
            ...
            <DeleteDialog
              ...
              description="This review will be permanently deleted from the menuItem page."
          ...
          <CardContent className="space-y-3">
            ...
            {review.menuItem?.slug ? (
              <Button asChild variant="link" className="h-auto p-0">
                <Link href={`/menu-item/${review.menuItem.slug}`}>View menuItem</Link>
              </Button>
            ) : null}
          </CardContent>
        </Card>
