  ...
  return (
    <div className="font-bold">
      ...
      <p className="mb-3 text-xs font-normal text-muted-foreground">
        Rates combine the selected delivery place base rate and the shipping
        speed charge.
      </p>
      ...
      >
        {availableDeliveryDates.map((dd) => (
          <div key={dd.name} className="flex">
            ...
            />
            <Label
              className="pl-2 space-y-2 cursor-pointer max-w-xs"
            ...
            >
              ...
              <div className="text-sm">
                {(() => {
                  const placeRecord = places.find(
                    (p) => p.city === selectedPlace,
                  );
                  ...
                  return (
                    <div className="flex flex-col">
                      ...
                      {locationRate > 0 && (
                        <span className="text-[10px] text-muted-foreground font-normal truncate max-w-xs">
                          (Speed: <Price price={dd.shippingPrice} plain /> +
                          Location: <Price price={locationRate} plain />)
                        </span>
                      )}
                    </div>
                  );
