          ...
          <div className="mb-4">
              ...
              effectiveDiscountAmount > 0 && (
                <div className="mt-2 rounded-md border border-emerald-500/30 bg-emerald-500/5 px-3 py-2 text-sm text-emerald-700">
                  ...
                  <span className="font-semibold">
                    <Price price={firstPurchaseDiscount.discountAmount} plain />
                  </span>
                  .
                </div>
              )}
            <div className="mt-4">
              ...
              <Textarea
                ...
                placeholder="Add delivery instructions or anything we should know"
                maxLength={500}
                rows={3}
              />
            ...
            <div className="space-y-2 mt-2">
              ...
              {discountAmount > 0 && (
                <div className="flex justify-between">
                  ...
                  <span>
                    -<Price price={discountAmount} plain />
                  </span>
                </div>
              )}
            </div>
