    ...
    links: [
      {
        ...
        title: "My Reviews",
        description:
          "See every review you have written and remove outdated ones",
        icon: Star,
      },
      {
      ...
      },
      {
        ...
        title: "Support",
        description:
          "Submit complaints, queries, or recommendations and track replies",
        icon: Headset,
      },
    ],
  },
      ...
      <TabsList className="grid h-auto w-full grid-cols-1 gap-1 rounded-xl p-1 sm:grid-cols-3">
        {tabGroups.map((group) => (
          <TabsTrigger
            key={group.value}
            value={group.value}
            className="min-h-10 w-full rounded-lg px-4 cursor-pointer"
          >
            {group.label}
          </TabsTrigger>
        ))}
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0 flex-1">
                      <div className="flex items-center justify-between gap-2">
                        <h2 className="text-sm font-semibold leading-none sm:text-base">
                          {link.title}
                        </h2>
