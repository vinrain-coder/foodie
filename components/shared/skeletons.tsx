...
export function AuthFormSkeleton() {
  return (
    <Card
      className="w-full shadow-md border rounded-2xl"
      role="status"
      aria-label="Loading"
    >
  ...
  return (
    <div className="space-y-6" role="status" aria-label="Loading">
      ...
      <div className="grid gap-4 lg:grid-cols-7">
        <Skeleton className="h-64 lg:col-span-4" aria-hidden="true" />
        <Skeleton className="h-64 lg:col-span-3" aria-hidden="true" />
      </div>
    </div>
  );
}
...
export function MaintenanceSkeleton() {
  return (
    <div
      className="flex flex-col items-center justify-center min-h-screen space-y-6 text-center px-4"
      role="status"
      aria-label="Loading"
    >
...
export function CatalogResultsSkeleton() {
  return (
    <div className="space-y-2 md:space-y-4" role="status" aria-label="Loading">
      ...
      <div className="my-1 rounded-xl bg-card p-2.5 md:my-2 md:border-b md:rounded-none md:px-0 md:py-3 flex flex-col md:flex-row md:items-center md:justify-between gap-2.5 md:gap-3">
        ...
        <div className="w-full md:w-auto md:ml-auto">
          <Skeleton className="h-10 w-full md:w-52" aria-hidden="true" />
        </div>
      </div>

      <div className="bg-card grid md:grid-cols-5 py-2 md:py-3 md:gap-6">
        <div className="hidden md:block md:col-span-1">
          <div className="sticky top-20 h-[calc(100vh-5rem)] overflow-auto rounded-lg border p-4 space-y-6">
            <Skeleton className="h-6 w-24" aria-hidden="true" />
            ...
            {Array.from({ length: 8 }).map((_, i) => (
              <Card key={i} className="p-0 overflow-hidden">
                ...
                <CardContent className="space-y-3 p-3">
                  ...
                  <Skeleton className="h-5 w-24 mx-auto" aria-hidden="true" />
                  <Skeleton className="h-10 w-full" aria-hidden="true" />
                </CardContent>
              </Card>
            ))}
...
export function SearchResultsSkeleton() {
  return (
    <div className="space-y-1 md:space-y-2" role="status" aria-label="Loading">
      <Skeleton className="h-4 w-40" aria-hidden="true" />
      ...
      <div className="bg-card grid md:grid-cols-5 py-1 md:py-2 md:gap-6">
        ...
        <div className="md:col-span-4 space-y-4">
          <div className="grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-4">
            {Array.from({ length: 8 }).map((_, i) => (
              <Card key={i} className="p-0 overflow-hidden">
                <Skeleton className="h-52 sm:h-56 w-full" aria-hidden="true" />
                <CardContent className="space-y-3 p-3">
                  <Skeleton className="h-4 w-3/4 mx-auto" aria-hidden="true" />
                  <Skeleton className="h-4 w-1/2 mx-auto" aria-hidden="true" />
                  <Skeleton className="h-5 w-24 mx-auto" aria-hidden="true" />
