...
export default function MenuItemGallery({ images }: { images: string[] }) {
        ...
        <div className="w-full">
          ...
          >
            ...
            <Image
              ...
              alt={`Menu item image ${activeImage + 1}`}
              fill
              className="object-contain"
              sizes="90vw"
              priority
            ...
            {lens.visible && (
              <div
                className="absolute pointer-events-none rounded-2xl border border-white/60 shadow-md"
                style={{
                  width: 150,
                  height: 150,
                  left: `calc(${smoothLens.x}% - 75px)`,
                  top: `calc(${smoothLens.y}% - 75px)`,
                  backgroundImage: `url(${safeImages[displayImage]})`,
                  backgroundRepeat: "no-repeat",
                  backgroundSize: `${scale * 120}% ${scale * 120}%`,
                  transition:
                    "background-size 0.1s ease, transform 0.05s linear",
